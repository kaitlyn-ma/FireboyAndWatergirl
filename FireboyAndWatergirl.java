...
public class FireboyAndWatergirl {
    ...
    /**
       Finds path from start (row 0 col 0) to end (row.length-1 col[row].length-1) of a 2D char "maze"
       By traveling horizontally or vertically, the collectedDiamonds 2D array is used to represent visited coordinates.

       @param maze 2D char array representing cell contents: F, W, G, N
       @param collectedDiamonds booleann 2D array representing each visited maze coordinate.
